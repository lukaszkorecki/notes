I'm still pretty new to JVM land, despite of using Clojure in production for a yar and some random past episodes of working on Android and JRuby projects.
